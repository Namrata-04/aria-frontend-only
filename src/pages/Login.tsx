      ...
      <div className="flex w-full max-w-4xl min-h-[600px] bg-white/80 rounded-2xl shadow-xl overflow-hidden border border-amber-100">
        ...
        <div className="flex-1 flex flex-col justify-center px-10 py-12 relative">
          ...
          <div className="absolute top-6 right-10">
            <Link to="/signup">
              <button className="px-4 py-1 rounded-full border border-teal-200 text-teal-700 font-semibold hover:bg-teal-50 transition text-sm">Sign Up</button>
            </Link>
          </div>
          {/* Welcome */}
          <h2 className="text-3xl font-bold text-teal-700 mb-2 text-center tracking-wide">LOGIN</h2>
